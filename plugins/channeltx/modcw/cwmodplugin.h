...
#ifndef INCLUDE_CWMODPLUGIN_H
#define INCLUDE_CWMODPLUGIN_H
...
/**
 * Plugin entry point for the CW (Morse code) modulator.
 *
 * Registers the channel type with SDRangel's plugin system and creates
 * instances of CWMod (and optionally CWModGUI in non-server builds).
 */
class CWModPlugin : public QObject, PluginInterface {
    Q_OBJECT
    Q_INTERFACES(PluginInterface)
    Q_PLUGIN_METADATA(IID "sdrangel.channeltx.modcw")
