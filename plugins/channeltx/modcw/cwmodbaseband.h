...
//                                                                               //
// CW Modulator — baseband processing layer                                      //
//                                                                               //
...
/** Baseband processing for the CW modulator.
 *
 *  Sits between the UpChannelizer and the CWModSource.  Receives configuration
 *  and DSP rate-change messages on its internal message queue and forwards them
 *  to the source.
 */
