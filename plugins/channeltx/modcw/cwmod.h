...
/**
 * CW (Morse code) modulator channel TX plugin for SDRangel.
 *
 * Encodes text as ITU-R Morse code and outputs a keyed carrier at a
 * configurable tone frequency. Smooth raised-cosine envelope shaping
 * prevents key clicks.
 */
class CWMod : public BasebandSampleSource, public ChannelAPI
{
public:
    /** Configure the CW modulator. */
    ...
    /** Trigger transmission of the configured message. */
