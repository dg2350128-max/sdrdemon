...
/** CW (Continuous Wave / Morse code) modulator channel. */
...
public:
    ...
    /** Trigger transmit using the currently configured text. */
    ...
    /** Transmit a specific text string. */
    ...
    /** Sent back to GUI when a transmission has completed. */
    class MsgReportTx : public Message {
        MESSAGE_CLASS_DECLARATION
    public:
        static MsgReportTx* create() { return new MsgReportTx(); }
    private:
        MsgReportTx() : Message() { }
    };
