...
//                                                                               //
// CW Modulator — main channel implementation                                    //
//                                                                               //
                ...
                QString& errorMessage)
{
    (void) response;
    (void) errorMessage;
    // Full WebAPI support requires regenerating the Swagger client with CWMod schemas.
    // For now return a minimal response.
    errorMessage = "CWMod WebAPI not yet fully implemented";
    return 501;
}
        ...
        QString& errorMessage)
{
    ...
    (void) query;
    errorMessage = "CWMod WebAPI actions not yet fully implemented";
    return 501;
}
...
void CWMod::webapiReverseSendSettings(const QList<QString>& channelSettingsKeys, const CWModSettings& settings, bool force)
{
    ...
    (void) settings;
    (void) force;
    // Reverse API send not yet implemented for CWMod
}
...
void CWMod::networkManagerFinished(QNetworkReply *reply)
{
    ...
    if (replyError)
    {
        qWarning() << "CWMod::networkManagerFinished:"
