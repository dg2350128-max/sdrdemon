...
//                                                                               //
// CW (Continuous Wave) Modulator — main channel class                           //
//                                                                               //
...
#ifndef PLUGINS_CHANNELTX_MODCW_CWMOD_H
#define PLUGINS_CHANNELTX_MODCW_CWMOD_H
...
/** CW (Continuous Wave) Modulator channel.
 *
 *  Generates a carrier keyed with Morse code using the CWKeyer DSP class.
 *  Intended for use with HackRF One / HackRF Pro output devices but works
 *  with any SDRangel-compatible transmitter.
 */
...
#endif // PLUGINS_CHANNELTX_MODCW_CWMOD_H
