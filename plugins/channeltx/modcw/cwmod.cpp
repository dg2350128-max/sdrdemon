...
// Minimal WebAPI: CW mod settings are not yet in the swagger spec.
int CWMod::webapiSettingsGet(
                SWGSDRangel::SWGChannelSettings& response,
                QString& errorMessage)
{
    (void) response;
    errorMessage = "CWMod settings not available via WebAPI (not in swagger spec)";
    return 501;
}
        ...
        QString& errorMessage)
{
    ...
    (void) query;
    errorMessage = "CWMod actions not available via WebAPI (not in swagger spec)";
    return 501;
}

void CWMod::webapiReverseSendSettings(const QList<QString>& channelSettingsKeys, const CWModSettings& settings, bool force)
{
    // Minimal reverse API: not fully implemented without swagger support
    (void) channelSettingsKeys;
    (void) settings;
    (void) force;
}
...
void CWMod::sendChannelSettings(
    ...
    bool force)
{
    // Not implemented without swagger support
    (void) pipes;
    (void) channelSettingsKeys;
    (void) settings;
    (void) force;
